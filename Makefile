...
#    Updated: 2019/06/27 13:27:29 by nkholane         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
		ft_memchr.c ft_memcmp.c	ft_strlen.c ft_strdup.c ft_strcpy.c ft_isspace.c\
...
OBJECT =ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
		ft_memchr.o ft_memcmp.o	ft_strlen.o ft_strdup.o ft_strcpy.o ft_isspace.o\
		...
		ft_isprint.o ft_toupper.o ft_tolower.o ft_islower.o ft_isupper.o \
